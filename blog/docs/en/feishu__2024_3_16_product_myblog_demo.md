...
Export the Feishu knowledge base and generate [Static Page Generator](https://www.google.com/search?q=Static+Page+Generator) in the same directory structure Support 'Markdown' file organization for publishing as a Static Website.
...
<div class="callout callout-bg-3 callout-border-3 callout-color-3"><div class='callout-emoji'>🤖</div>
<p>Yellow Callout</p>
</div>
